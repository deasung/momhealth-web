...
# 기본 환경 변수 (런타임에 덮어쓸 수 있음)
ENV NEXTAUTH_URL=https://medigen.ai.kr
ENV NEXTAUTH_SECRET=92nkzVApA5J9Fne9s8XeQAGdEkOiTK+v+1cztN/eTok=
ENV MOMHEATH_API_URL=https://895txa0nrk.execute-api.ap-northeast-2.amazonaws.com/production
ENV MOMHEATH_API_KEY=f5e60c40-5eb4-11ea-b4d7-0d9c1606f185
